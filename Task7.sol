...
function trade(address tokenA, uint256 amountA, address tokenB, uint256 amountB) public {
        ...
        require(balanceOf(tokenA) >= amountA, "Insufficient balance of tokenA");
        require(balanceOf(tokenB) >= amountB, "Insufficient balance of tokenB");
        balances[tokenB]-=amountB;
        balances[tokenA]+=amountB;
        balances[tokenA]-=amountA;
        balances[tokenB]+=amountA;
    }
}
